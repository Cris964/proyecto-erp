    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in">
        ...
        <div className="bg-white p-8 rounded-[40px] shadow-xl border flex flex-col justify-between">
            <div className="space-y-6">
                ...
                {esElectronica && <input className="p-3 bg-slate-100 border-none rounded-xl text-xs font-bold text-slate-700" placeholder="Email" onChange={e=>setCliente({email: e.target.value})} />}
            </div>
