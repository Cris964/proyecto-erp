...
// ================= RUTAS DE LA API (SIN PREFIJO /API PORQUE VERCEL YA LO PONE) =================
...
app.get('/turnos/activo/:id', async(r,s)=>{
...
app.get('/nomina/historial', async(r,s)=>{
